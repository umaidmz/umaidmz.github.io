...
description: The project involved using edge BLE devices like Arduino Nano, XIAO, Sensortile box to predict activities in a room and analyze the trends, making sure to highlight patient requiring immediate attention.
